...
import { getCharacters, getCharacterById } from "./character.service";
...
describe("Character Service", () => {
  ...
  describe("getCharacters", () => {
    it("should return paginated characters", async () => {
      ...
      mockPrisma.character.count.mockResolvedValue(826);
      ...
      expect(mockPrisma.character.findMany).toHaveBeenCalledTimes(1);
      expect(mockPrisma.character.count).toHaveBeenCalledTimes(1);
    });

    it("should calculate pagination correctly", async () => {
      mockPrisma.character.findMany.mockResolvedValue([]);
      mockPrisma.character.count.mockResolvedValue(50);
    ...
    it("should propagate database errors", async () => {
      ...
      mockPrisma.character.findMany.mockRejectedValue(databaseError);
      mockPrisma.character.count.mockResolvedValue(0);
  ...
  describe("getCharacterById", () => {
    ...
    it("should propagate database errors when finding a character", async () => {
      ...
      mockPrisma.character.findUnique.mockRejectedValue(databaseError);
